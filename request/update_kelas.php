            ...
            <div class="wrapper">
                ...
                ?>
                    ...
                    <form action="update.php" method="POST" class="kirim">
                        ...
                        <div class="input-box">
                            <input type="text" placeholder="Nama Kelas" value="<?= $data['nama_kelas'] ?>" name="nama_kelas" required>
                        </div>
                        <div class="input-box">
                            <input type="text" placeholder="Prodi" value="<?= $data['prodi'] ?>" name="prodi" required>
                        </div>
                        <div style="height: 15px;"></div>
                        <button type="submit" class="btn" name="update_kelas">
                            <h4>Kirim</h4>
                        </button>
                        <div style="height: 15px;"></div>
                    </form>
