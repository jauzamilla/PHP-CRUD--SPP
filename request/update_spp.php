    ...
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="./pages/histori_pembayaran.php">
            ...
            <div class="wrapper">
                ...
                ?>
                    ...
                    <form action="update.php" method="POST" class="kirim">
                        ...
                        <div class="input-box">
                            <input type="text" placeholder="Bulan" value="<?= $data['bulan'] ?>" name="bulan" required>
                        </div>
                        <div class="input-box">
                            <input type="text" placeholder="Tahun" value="<?= $data['tahun'] ?>" name="tahun" required>
                        </div>
                        <div class="input-box">
                            <input type="text" placeholder="Nominal" value="<?= $data['nominal'] ?>" name="nominal" required>
                        </div>
                        <div style="height: 15px;"></div>

                        <button type="submit" class="btn" name="update_spp">Kirim</button>
                        <div style="height: 15px;"></div>
